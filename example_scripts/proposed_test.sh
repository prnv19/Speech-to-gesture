...
for seq in `seq 1094 2 1182`; 
		...
		echo
                ...
                CUDA_VISIBLE_DEVICES=$GPU python decode.py $data_dir enc_${dim}_prediction${seq}.txt ../../example_scripts/gestures/gesture${seq}.txt -restore=True -pretrain=False -layer1_width=$dim -chkpt_dir='/home/ubuntu/Speech-to-gesture/MoCap/'$dim -batch_size=8
